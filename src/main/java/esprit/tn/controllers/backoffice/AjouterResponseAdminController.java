...
public class AjouterResponseAdminController {
    ...
    private void redirectToListResponses() {
        try {
            ...
            showAlert("Error", "Failed to load ListResponsesAdmin page: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void redirectToListForums() {
        try {
            ...
            showAlert("Error", "Failed to load ListForumsAdmin page: " + e.getMessage());
            e.printStackTrace();
        }
    }
