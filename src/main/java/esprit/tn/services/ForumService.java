...
public class ForumService {
    ...
    public boolean forumExists(String title) {
        String query = "SELECT COUNT(*) FROM forum WHERE title = ?";
        try (PreparedStatement stmt = cnx.prepareStatement(query)) {
            ...
            throw new RuntimeException("Error checking forum existence: " + e.getMessage());
        }
        return false;
    }
